...
knitr::opts_chunk$set(
  echo = FALSE,
  fig.path = "images/")
#source("scrape-earwolf.R")
source("cbb_bestof-figure.R")
```
...
I scraped the data directly from the Earwolf website using the `scrape-earwolf.R`, and then created the image via `cbb_bestof-figure.R`.
